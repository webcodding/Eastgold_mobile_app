...
import ManagerDashboard from "./DashboardScreen";
import ManagerWalletScreen from "./WalletScreen";
...
const ManagerBottomTabs = ({ route, navigation }) => {
  ...
  return (
    ...
    >
      ...
      >
        {() => <ManagerDashboard navigation={navigation} profile={profile} />}
      </Tab.Screen>
      <Tab.Screen
        name="Sales"
        options={{
      ...
      >
        {() => <SalesScreen navigation={navigation} profile={profile} />}
      </Tab.Screen>
      <Tab.Screen
        name="Performance"
        options={{
      ...
      >
        {() => (
          <ManagerWalletScreen navigation={navigation} profile={profile} />
        )}
      </Tab.Screen>
    </Tab.Navigator>
  );
